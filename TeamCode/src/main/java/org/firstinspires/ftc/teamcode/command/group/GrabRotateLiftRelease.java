...
public class GrabRotateLiftRelease extends SequentialCommandGroup {
    public GrabRotateLiftRelease( ArmSubsystem arm, LiftSubsystem lift, WristSubsystem wrist, ClawSubsystem claw, Junction junction) {
        addCommands(
                ...
                ), new DelayedCommand(new Grab(claw), 700)
        );
